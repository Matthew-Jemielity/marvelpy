...
class Creator( Object ):
    def _update( self, **kwargs ):
        ...
        self._attribute[ "series" ], self._attribute[ "stories" ], self._attribute[ "comics" ], self._attribute[ "events" ] = SummaryCollection( kwargs[ "series" ], Series ), SummaryCollection( kwargs[ "stories" ], Story ), SummaryCollection( kwargs[ "comics" ], Comic ), SummaryCollection( kwargs[ "events" ], Event )
        return super()._update( [ "urls", "series", "stories", "comics", "events" ], kwargs )
    def attributes( self = None ): return [ "id", "firstName", "middleName", "lastName", "suffix", "fullName", "modified", "resourceURI", "urls", "thumbnail", "series", "stories", "comics", "events" ]
    def collection( self = None ): return CreatorCollection
    def comics( self ): return self._attribute[ "comics" ]
    def endpoint( self = None ): return Object.endpoint( self, "creators" )
    def events( self ): return self._attribute[ "events" ]
    def first_name( self ): return self._attribute[ "firstName" ]
    def full_name( self ): return self._attribute[ "fullName" ]
    def last_name( self ): return self._attribute[ "lastName" ]
    def middle_name( self ): return self._attribute[ "middleName" ]
    def series( self ): return self._attribute[ "series" ]
    def stories( self ): return self._attribute[ "stories" ]
    def suffix( self ): return self._attribute[ "suffix" ]
    def type( self = None ): return Creator
...
class CreatorCollection( ObjectCollection ):
    def __init__( self, resource = "%s%s" % ( Api.endpoint(), "creators" ), data = None ):
    ...
    def collection( self = None ): return CreatorCollection
    def endpoint( self = None ): return ObjectCollection.endpoint( self, "creators" )
    def type( self = None ): return Creator
