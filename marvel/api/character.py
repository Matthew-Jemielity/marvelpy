...
class Character( Object ):
    def _update( self, **kwargs ):
        ...
        self._attribute[ "comics" ], self._attribute[ "stories" ], self._attribute[ "events" ], self._attribute[ "series" ] = SummaryCollection( kwargs[ "comics" ], Comic ), SummaryCollection( kwargs[ "stories" ], Story ), SummaryCollection( kwargs[ "events" ], Event ), SummaryCollection( kwargs[ "series" ], Series )
        return super()._update( [ "urls", "comics", "stories", "events", "series" ], **kwargs )
    def attributes( self = None ): return [ "id", "name", "description", "modified", "resourceURI", "urls", "thumbnail", "comics", "stories", "events", "series" ]
    def collection( self = None ): return CharacterCollection
    def comics( self ): return self._attribute[ "comics" ]
    def description( self ): return self._attribute[ "description" ]
    def endpoint( self = None ): return Object.endpoint( self, "characters" )
    def events( self ): return self._attribute[ "events" ]
    def name( self ): return self._attribute[ "name" ]
    def series( self ): return self._attribute[ "series" ]
    def stories( self ): return self._attribute[ "stories" ]
    def type( self = None): return Character
...
class CharacterCollection( ObjectCollection ):
    def __init__( self, resource = "%s%s" % ( Api.endpoint(), "characters" ), data = None ):
    ...
    def collection( self = None ): return CharacterCollection
    def endpoint( self = None ): return ObjectCollection.endpoint( self, "characters" )
    def type( self = None ): return Character
