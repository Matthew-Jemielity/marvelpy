...
class Event(Object):
    ...
    def _update(self, **kwargs):
        ...
        self._attribute["next"] = Summary(kwargs["next"], Event)
        self._attribute["previous"] = Summary(kwargs["previous"], Event)
    ...
    def end(self):
        return self._attribute["end"]

    def endpoint(self=None):
        return Object.endpoint(self, "events")
    ...
    def start(self):
        return self._attribute["start"]

    def stories(self):
        return self._attribute["stories"]

    def title(self):
        return self._attriubte["title"]
...
class EventCollection(ObjectCollection):
    ...
    def __init__(
        self,
        resource="%s%s" % (Api.endpoint(), "events"),
        data=None
    ):
    ...
    def endpoint(self=None):
        return ObjectCollection.endpoint(self, "events")
